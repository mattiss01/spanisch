...
import { getArticleRecords, recordExercise } from '@/lib/storage';
import { ArticleRecord, ArticleExercise as ArticleExerciseType } from '@/lib/types';
import ArticleExercise from '@/components/exercises/ArticleExercise';
import { ARTICLE_CATALOG, buildArticleExercise, getArticleTopic } from '@/lib/article-catalog';
...
export default function ArtikelPage() {
  ...
  const refresh = useCallback(async () => setRecords(await getArticleRecords()), []);
  ...
  return (
    <main className="md:ml-56 min-h-screen bg-gray-50 pb-24 md:pb-8">
      <div className="max-w-xl mx-auto p-5 space-y-5">
        ...
        {/* ── Aprender tab: pick a grammar topic ── */}
        {tab === 'aprender' && (
          <div className="space-y-3">
            {ARTICLE_CATALOG.map(topic => {
